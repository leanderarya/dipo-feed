...
void main() {
  group('CurrencyFormatter Tests', () {
    test(
      'formatRupiah formats double/int correctly with decimals and symbols',
      () {
        expect(CurrencyFormatter.formatRupiah(3500), 'Rp 3.500,00');
        expect(CurrencyFormatter.formatRupiah(1500000), 'Rp 1.500.000,00');
        expect(
          CurrencyFormatter.formatRupiah(1250.5, withDecimals: true),
          'Rp 1.250,50',
        );
        expect(
    ...
    test(
      'parseRupiah parses Indonesian formatted currency strings correctly',
      () {
        ...
        expect(CurrencyFormatter.parseRupiah('1.23'), 0.0);
      },
    );
  });
