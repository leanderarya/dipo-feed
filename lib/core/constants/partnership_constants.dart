/// Konstanta data dan narasi resmi kemitraan DipoFeed (IndoDairy 2, FPP UNDIP & ACIAR)
class PartnershipConstants {
  PartnershipConstants._();

  /// Teks narasi pengantar kolaborasi IndoDairy 2
  static const String introText =
      'DipoFeed merupakan inovasi hasil kolaborasi Fakultas Peternakan dan Pertanian Universitas Diponegoro (FPP UNDIP) '
      'bersama Australian Centre for International Agricultural Research (ACIAR) melalui penelitian IndoDairy 2. '
      'Aplikasi ini dapat digunakan oleh peternak, petugas lapangan, maupun penyuluh sebagai sarana pendukung dalam pengelolaan usaha peternakan.';
  ...
  /// Logo Australian Aid untuk Splash Footer
  static const String australianAidLogo = 'assets/images/logo_australian_aid.png';
}
